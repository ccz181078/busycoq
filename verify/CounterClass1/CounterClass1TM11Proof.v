Require Import BusyCoq.CounterClass1.CounterClass1_v11 BusyCoq.CounterClass1.CounterClass1Common BusyCoq.CounterClass1.CounterClass1K4CycleLow0
  BusyCoq.CounterClass1.CounterClass1K4FiniteNLow0 Lia.
...
Definition complex_rules:K4ComplexRules P K4Low0.
Proof.
  refine (@Build_K4ComplexRules P K4Low0 simple_rules _ PLOv1' _ _ _).
  - intros _. exact PInc00_0.
...
Proof. exact (k4n_low0_prebase_data P complex_rules PRst0). Qed.

Lemma nonhalt:~halts tm c0.
Proof.
  eapply sigma_score_unbounded_nonhalt. intros n.
  destruct (k4_low0_cycle_left_row1 P complex_rules prebase_data n)
    as (b&c&d&HP&Hout).
  eexists _,_; split.
  - apply P0_spec. exact (P0Init b c d HP).
  - split.
    + unfold L2. solve_sigma_score.
    + pose proof (k4_low0_cycle_height P prebase_data n). lia.
Qed.
