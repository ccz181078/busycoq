Require Import BusyCoq.CounterClass1.CounterClass1_v15 BusyCoq.CounterClass1.CounterClass1Common BusyCoq.CounterClass1.CounterClass1K5Common
...
Proof.
  ...
  destruct (k5_state_row P s 3 Hs ltac:(lia)) as (b&c&d&HP&Hout).
  eexists _,_; split.
