...
Definition tm := Eval compute in (TM_from_str "1RB1RF_1RC1RE_1LD---_0LF0LE_0RA1LD_1RA0LF").
...
| CC_D_Ae_tail2 n q :
    q <= n ->
    ClosedCall D (SAe n q 2) B (SBe n 0 (4 * q + 5))
| CC_D_Ao_tail2 n q :
    q <= n ->
    ClosedCall D (SAo n q 2) B (SBo n 0 (4 * q + 5))
| CC_D_Ae_long_nonmax n q k :
    q < n ->
    k <= 4 * n + 3 ->
    ClosedCall D (SAe n q (2 * k + 4)) A (SAe n (q + 1) (2 * k))
| CC_D_Ao_long_nonmax n q k :
    q < n ->
    k <= 4 * n + 5 ->
    ClosedCall D (SAo n q (2 * k + 4)) A (SAo n (q + 1) (2 * k))
| CC_D_Ae_long_diag_low n k :
    k <= 2 * n + 2 ->
    ClosedCall D (SAe n n (2 * k + 4)) A (SBo n 0 (2 * k))
| CC_D_Ae_long_diag_high n s :
    s <= 2 * n ->
    ClosedCall D (SAe n n (2 * (2 * n + 3 + s) + 4)) A (SPe (n + 1) (2 * s))
| CC_D_Ao_long_diag_low n k :
    k <= 2 * n + 4 ->
    ClosedCall D (SAo n n (2 * k + 4)) A (SBe (n + 1) 0 (2 * k))
| CC_D_Ao_long_diag_high n s :
    s <= 2 * n ->
    ClosedCall D (SAo n n (2 * (2 * n + 5 + s) + 4)) A (SPo (n + 1) (2 * s))
...
| CC_D_Be0_1 n :
    ClosedCall D (SBe n 0 1) B (SBe n 0 1)
| CC_D_Bo0_1 n :
    ClosedCall D (SBo n 0 1) B (SBo n 0 1)
| CC_D_Be0_2_succ n :
    ClosedCall D (SBe (n + 1) 0 2) B (SPe (n + 1) 3)
| CC_D_Bo0_2 n :
    ClosedCall D (SBo (n + 1) 0 2) B (SPo (n + 1) 3)
| CC_D_Be0_odd_tail n k :
    k <= 2 * n + 1 ->
    ClosedCall D (SBe n 0 (2 * k + 3)) A (SAe n 0 (2 * k))
| CC_D_Bo0_odd_tail n k :
    k <= 2 * n + 1 ->
    ClosedCall D (SBo n 0 (2 * k + 3)) A (SAo n 0 (2 * k))
| CC_D_Be0_even_tail n k :
    k <= 2 * (n + 1) ->
    ClosedCall D (SBe (n + 1) 0 (2 * k + 4)) A (SBe (n + 1) 1 (2 * k))
| CC_D_Bo0_even_tail n k :
    k <= 2 * (n + 1) ->
    ClosedCall D (SBo (n + 1) 0 (2 * k + 4)) A (SBo (n + 1) 1 (2 * k))
...
| CC_D_Be_pos_tail2 n j :
    1 <= j ->
    j < n ->
    ClosedCall D (SBe n j 2) B (SPe n (4 * j + 3))
| CC_D_Be_diag_tail2 n :
    ClosedCall D (SBe n n 2) F (SBe n 0 (4 * n + 3))
| CC_D_Be_diag_tail4 n :
    ClosedCall D (SBe n n 4) B (SBe n 0 (4 * n + 5))
| CC_D_Be_pos_long n j k :
    1 <= j ->
    j < n ->
    k <= 2 * n + 1 ->
    ClosedCall D (SBe n j (2 * k + 4)) A (SBe n (j + 1) (2 * k))
| CC_D_Be_diag_long_low n k :
    k <= 2 * n ->
    ClosedCall D (SBe n n (2 * k + 6)) A (SBo n 0 (2 * k))
...
| CC_D_Bo_pos_tail2 n j :
    1 <= j ->
    j < n ->
    ClosedCall D (SBo n j 2) B (SPo n (4 * j + 3))
| CC_D_Bo_diag_tail2 n :
    ClosedCall D (SBo n n 2) F (SAe n n (7 + 4 * n))
| CC_D_Bo_diag_tail4 n :
    ClosedCall D (SBo n n 4) B (SBo n 0 (4 * n + 5))
| CC_D_Bo_pos_long n j k :
    1 <= j ->
    j < n ->
    k <= 2 * n + 3 ->
    ClosedCall D (SBo n j (2 * k + 4)) A (SBo n (j + 1) (2 * k))
| CC_D_Bo_diag_long_low n k :
    k <= 2 * n + 2 ->
    ClosedCall D (SBo n n (2 * k + 6)) A (SBe (n + 1) 0 (2 * k))

| CC_D_Pe_succ_even n k :
    k <= 2 ->
    ClosedCall D (SPe (n + 2) (2 * k)) A (SBo (n + 1) 1 (6 + 4 * n + 2 * k))
| CC_D_Pe_odd n k :
    k <= 2 * n + 3 ->
    ClosedCall D (SPe (n + 1) (2 * k + 1)) A (SAo n 0 (4 + 4 * n + 2 * k))
| CC_D_Po_even n k :
    k = 0 ->
    ClosedCall D (SPo (n + 1) (2 * k)) A (SBe (n + 1) 1 (6 + 4 * n + 2 * k))
| CC_D_Po_odd n k :
    k <= 2 * n + 1 ->
    ClosedCall D (SPo n (2 * k + 1)) A (SAe n 0 (4 + 4 * n + 2 * k))

| CC_E_Ae_1 n q :
    q <= n ->
    ClosedCall E (SAe n q 1) A (SBe n 0 (4 * q + 4))
| CC_E_Ao_1 n q :
    q <= n ->
    ClosedCall E (SAo n q 1) A (SBo n 0 (4 * q + 4))
| CC_E_Ae_3_nonmax n q :
    q < n ->
    ClosedCall E (SAe n q 3) E (SBe n 0 (4 * q + 6))
| CC_E_Ae_3_diag n :
    ClosedCall E (SAe n n 3) E (SPo n 0)
| CC_E_Ao_3_nonmax n q :
    q < n ->
    ClosedCall E (SAo n q 3) E (SBo n 0 (4 * q + 6))
| CC_E_Ao_3_diag n :
    ClosedCall E (SAo n n 3) E (SPe (n + 1) 0)
| CC_E_Ae_long_nonmax n q k :
    q < n ->
    k <= 4 * n + 2 ->
    ClosedCall E (SAe n q (2 * k + 5)) F (SAe n (q + 1) (2 * k + 1))
| CC_E_Ao_long_nonmax n q k :
    q < n ->
    k <= 4 * n + 4 ->
    ClosedCall E (SAo n q (2 * k + 5)) F (SAo n (q + 1) (2 * k + 1))
| CC_E_Ae_long_diag_low n k :
    k <= 2 * n + 2 ->
    ClosedCall E (SAe n n (2 * k + 5)) F (SBo n 0 (2 * k + 1))
| CC_E_Ae_long_diag_high n s :
    s < 2 * n ->
    ClosedCall E (SAe n n (2 * (2 * n + 3 + s) + 5)) F (SPe (n + 1) (2 * s + 1))
| CC_E_Ao_long_diag_low n k :
    k <= 2 * n + 4 ->
    ClosedCall E (SAo n n (2 * k + 5)) F (SBe (n + 1) 0 (2 * k + 1))
| CC_E_Ao_long_diag_high n s :
    s < 2 * n ->
    ClosedCall E (SAo n n (2 * (2 * n + 5 + s) + 5)) F (SPo (n + 1) (2 * s + 1))

| CC_E_Be0_0 n :
    ClosedCall E (SBe n 0 0) A (SBe n 0 0)
| CC_E_Bo0_0 n :
    ClosedCall E (SBo n 0 0) A (SBo n 0 0)
| CC_E_Be0_1 n :
    ClosedCall E (SBe (n + 1) 0 1) A (SPe (n + 1) 2)
| CC_E_Bo0_1 n :
    ClosedCall E (SBo (n + 1) 0 1) A (SPo (n + 1) 2)
| CC_E_Be0_2 n :
    ClosedCall E (SBe n 0 2) E (SBe n 0 2)
| CC_E_Bo0_2 n :
    ClosedCall E (SBo n 0 2) E (SBo n 0 2)
| CC_E_Be0_3 n :
    ClosedCall E (SBe (n + 1) 0 3) E (SPe (n + 1) 4)
| CC_E_Bo0_3 n :
    ClosedCall E (SBo (n + 1) 0 3) E (SPo (n + 1) 4)
| CC_E_Be0_even_tail n k :
    k <= 2 * n ->
    ClosedCall E (SBe n 0 (2 * k + 4)) F (SAe n 0 (2 * k + 1))
| CC_E_Bo0_even_tail n k :
    k <= 2 * n ->
    ClosedCall E (SBo n 0 (2 * k + 4)) F (SAo n 0 (2 * k + 1))
| CC_E_Be0_odd_tail n k :
    k <= 2 * (n + 1) ->
    ClosedCall E (SBe (n + 1) 0 (2 * k + 5)) F (SBe (n + 1) 1 (2 * k + 1))
| CC_E_Bo0_odd_tail n k :
    k <= 2 * (n + 1) ->
    ClosedCall E (SBo (n + 1) 0 (2 * k + 5)) F (SBo (n + 1) 1 (2 * k + 1))

| CC_E_Be_pos_1 n j :
    1 <= j ->
    j < n ->
    ClosedCall E (SBe n j 1) A (SPe n (4 * j + 2))
| CC_E_Be_succ_diag_1 n :
    ClosedCall E (SBe (n + 1) (n + 1) 1) C (SAo n n (10 + 4 * n))
| CC_E_Be_pos_3 n j :
    1 <= j ->
    j < n ->
    ClosedCall E (SBe n j 3) E (SPe n (4 * j + 4))
| CC_E_Be_diag_3 n :
    ClosedCall E (SBe n n 3) A (SBe n 0 (4 * n + 4))
| CC_E_Be_diag_5 n :
    ClosedCall E (SBe n n 5) E (SPo n 0)
| CC_E_Be_pos_long n j k :
    1 <= j ->
    j < n ->
    k <= 2 * n ->
    ClosedCall E (SBe n j (2 * k + 5)) F (SBe n (j + 1) (2 * k + 1))
| CC_E_Be_diag_long_low n k :
    k < 2 * n ->
    ClosedCall E (SBe n n (2 * k + 7)) F (SBo n 0 (2 * k + 1))
| CC_E_Bo_pos_1 n j :
    1 <= j ->
    j < n ->
    ClosedCall E (SBo n j 1) A (SPo n (4 * j + 2))
| CC_E_Bo_succ_diag_1 n :
    ClosedCall E (SBo (n + 1) (n + 1) 1) C (SAe (n + 1) n (10 + 4 * (n + 1)))
| CC_E_Bo_pos_3 n j :
    1 <= j ->
    j < n ->
    ClosedCall E (SBo n j 3) E (SPo n (4 * j + 4))
| CC_E_Bo_diag_3 n :
    ClosedCall E (SBo n n 3) A (SBo n 0 (4 * n + 4))
| CC_E_Bo_diag_5 n :
    ClosedCall E (SBo n n 5) E (SPe (n + 1) 0)
| CC_E_Bo_pos_long n j k :
    1 <= j ->
    j < n ->
    k <= 2 * n + 2 ->
    ClosedCall E (SBo n j (2 * k + 5)) F (SBo n (j + 1) (2 * k + 1))
| CC_E_Bo_diag_long_low n k :
    k <= 2 * n + 1 ->
    ClosedCall E (SBo n n (2 * k + 7)) F (SBe (n + 1) 0 (2 * k + 1))

| CC_E_Pe_even n k :
    k <= 2 * n + 3 ->
    ClosedCall E (SPe (n + 1) (2 * k)) F (SAo n 0 (3 + 4 * n + 2 * k))
| CC_E_Pe_succ_odd n k :
    k <= 1 ->
    ClosedCall E (SPe (n + 2) (2 * k + 1)) F (SBo (n + 1) 1 (7 + 4 * n + 2 * k))
| CC_E_Po_even n k :
    k <= 2 * n + 1 ->
    ClosedCall E (SPo n (2 * k)) F (SAe n 0 (3 + 4 * n + 2 * k))

| CC_F_Ae_0 n q :
    q <= n ->
    ClosedCall F (SAe n q 0) A (SBe n 0 (4 * q + 3))
| CC_F_Ao_0 n q :
    q <= n ->
    ClosedCall F (SAo n q 0) A (SBo n 0 (4 * q + 3))
| CC_F_Ae_1 n q :
    q <= n ->
    ClosedCall F (SAe n q 1) B (SBe n 0 (4 * q + 4))
| CC_F_Ao_1 n q :
    q <= n ->
    ClosedCall F (SAo n q 1) B (SBo n 0 (4 * q + 4))
| CC_F_Ae_2 n q :
    q <= n ->
    ClosedCall F (SAe n q 2) C (SBe n 0 (4 * q + 5))
| CC_F_Ao_2 n q :
    q <= n ->
    ClosedCall F (SAo n q 2) C (SBo n 0 (4 * q + 5))
| CC_F_Ae_special n q :
    q <= n ->
...
| CC_F_Ae_tail_0 n q m :
    q <= n ->
    m <= n ->
    ClosedCall F (SAe n q (4 * m + 4)) A (SAe n m (4 * q + 4))
| CC_F_Ao_tail_0 n q m :
    q <= n ->
    m <= n ->
    ClosedCall F (SAo n q (4 * m + 4)) A (SAo n m (4 * q + 4))
| CC_F_Ae_tail_1 n q m :
    q <= n ->
    m <= n ->
    ClosedCall F (SAe n q (4 * m + 5)) B (SAe n m (4 * q + 5))
| CC_F_Ao_tail_1 n q m :
    q <= n ->
    m <= n ->
    ClosedCall F (SAo n q (4 * m + 5)) B (SAo n m (4 * q + 5))
| CC_F_Ae_tail_2 n q m :
    q <= n ->
    m <= n ->
    ClosedCall F (SAe n q (4 * m + 6)) C (SAe n m (4 * q + 6))
| CC_F_Ao_tail_2 n q m :
    q <= n ->
    m <= n ->
    ClosedCall F (SAo n q (4 * m + 6)) C (SAo n m (4 * q + 6))
...
| CC_F_Be_small0 n j :
    ClosedCall F (SBe n j 0) A (SPe n (4 * j + 1))
| CC_F_Bo_small0 n j :
    ClosedCall F (SBo n j 0) A (SPo n (4 * j + 1))
| CC_F_Be_small1 n j :
    ClosedCall F (SBe n j 1) B (SPe n (4 * j + 2))
| CC_F_Bo_small1 n j :
    ClosedCall F (SBo n j 1) B (SPo n (4 * j + 2))
| CC_F_Be_small2 n j :
    ClosedCall F (SBe n j 2) C (SPe n (4 * j + 3))
| CC_F_Bo_small2 n j :
    ClosedCall F (SBo n j 2) C (SPo n (4 * j + 3))
...
| CC_F_Be_A_range_4 n j m :
    j <= n ->
    m <= n ->
    ClosedCall F (SBe (n + 1) j (4 * m + 4)) A (SAo n m (8 + 4 * n + 4 * j))
| CC_F_Be_A_range_5 n j m :
    j <= n ->
    m <= n ->
    ClosedCall F (SBe (n + 1) j (4 * m + 5)) B (SAo n m (9 + 4 * n + 4 * j))
| CC_F_Be_A_range_6 n j m :
    j <= n ->
    m <= n ->
    ClosedCall F (SBe (n + 1) j (4 * m + 6)) C (SAo n m (10 + 4 * n + 4 * j))
...
| CC_F_Bo_A_range_4 n j m :
    j <= n ->
    m <= n ->
    ClosedCall F (SBo n j (4 * m + 4)) A (SAe n m (8 + 4 * n + 4 * j))
| CC_F_Bo_A_range_5 n j m :
    j <= n ->
    m <= n ->
    ClosedCall F (SBo n j (4 * m + 5)) B (SAe n m (9 + 4 * n + 4 * j))
| CC_F_Bo_A_range_6 n j m :
    j <= n ->
    m <= n ->
    (m < n \/ 1 <= j) ->
    ClosedCall F (SBo n j (4 * m + 6)) C (SAe n m (10 + 4 * n + 4 * j))
...
| CC_F_Be_past_4_j0 n s :
    s = 0 ->
    ClosedCall F (SBe (n + 1) 0 (4 * (n + 1 + s) + 4)) A (SBe (n + 1) 0 (8 + 4 * n))
| CC_F_Be_past_5_j0 n s :
    s = 0 ->
    ClosedCall F (SBe (n + 1) 0 (4 * (n + 1 + s) + 5)) B (SBe (n + 1) 0 (9 + 4 * n))
...
| CC_F_Pe_succ_0 n :
    ClosedCall F (SPe (n + 1) 0) C (SAe n n (10 + 4 * n))
| CC_F_Po_0 n :
    ClosedCall F (SPo n 0) C (SPo n 0)
| CC_F_Pe_1 n :
    1 <= n ->
    ClosedCall F (SPe n 1) F (SPe n 1)
| CC_F_Pe_2 n :
    1 <= n ->
    ClosedCall F (SPe n 2) A (SPe n 2)
| CC_F_Pe_3 n :
    1 <= n ->
    ClosedCall F (SPe n 3) B (SPe n 3)
| CC_F_Pe_4 n :
    1 <= n ->
    ClosedCall F (SPe n 4) C (SPe n 4)
| CC_F_Pe_large_1 n m :
    m < n ->
    ClosedCall F (SPe (n + 1) (4 * m + 5)) F (SBo n (m + 1) (7 + 4 * n))
| CC_F_Pe_large_2 n m :
    m < n ->
    ClosedCall F (SPe (n + 1) (4 * m + 6)) A (SBo n (m + 1) (8 + 4 * n))
| CC_F_Pe_large_3 n m :
    m < n ->
    ClosedCall F (SPe (n + 1) (4 * m + 7)) B (SBo n (m + 1) (9 + 4 * n))
| CC_F_Pe_large_4 n m :
    m < n ->
    ClosedCall F (SPe (n + 1) (4 * m + 8)) C (SBo n (m + 1) (10 + 4 * n))
| CC_F_Po_pos_1 n m :
    m <= n ->
    ClosedCall F (SPo (n + 1) (4 * m + 1)) F (SBe (n + 1) (m + 1) (7 + 4 * n))
| CC_F_Po_pos_2 n m :
    m <= n ->
    ClosedCall F (SPo (n + 1) (4 * m + 2)) A (SBe (n + 1) (m + 1) (8 + 4 * n))
| CC_F_Po_pos_3 n m :
    m <= n ->
    ClosedCall F (SPo (n + 1) (4 * m + 3)) B (SBe (n + 1) (m + 1) (9 + 4 * n))
| CC_F_Po_pos_4 n m :
    m <= n ->
    ClosedCall F (SPo (n + 1) (4 * m + 4)) C (SBe (n + 1) (m + 1) (10 + 4 * n))
| CC_F_Be_top_3 n m :
    m <= n ->
    ClosedCall F (SBe (n + 1) (n + 1) (4 * m + 3)) F (SAo n m (11 + 8 * n))
| CC_F_Be_top_4 n m :
    m <= n ->
    ClosedCall F (SBe (n + 1) (n + 1) (4 * m + 4)) A (SAo n m (12 + 8 * n))
| CC_F_Be_top_5 n m :
    m <= n ->
    ClosedCall F (SBe (n + 1) (n + 1) (4 * m + 5)) B (SAo n m (13 + 8 * n))
| CC_F_Be_top_6 n m :
    m <= n ->
    ClosedCall F (SBe (n + 1) (n + 1) (4 * m + 6)) C (SAo n m (14 + 8 * n))
...
Lemma sideRLs_D_Bo0_1 :
  sideRLs (flip tm) [((E, []), (C, []))] (to_side (SBo 0 0 1)) (to_side (SPo 0 3)).
Proof.
  cbn [to_side].
...
Lemma sideRLs_D_Bo0_5 :
  sideRLs (flip tm) [((E, []), (E, []))] (to_side (SBo 0 0 5)) (to_side (SPe 1 0)).
Proof.
  cbn [to_side].
...
Lemma sideRLs_E_keep_1 r :
  sideRLs (flip tm) [((A, []), (F, []))] (S1 >> r) (S1 >> r).
Proof.
  esx.
Qed.

Lemma sideRLs_F_0_to_1 r :
  sideRLs (flip tm) [((F, []), (A, []))] (S0 >> r) (S1 >> r).
Proof.
  esx.
Qed.
...
Proof.
  ...
  - replace 2 with (S 1) by flia.
    ...
    normalize_split_sideRLs_concat.
    { ih_by IH E (SAe n q2 1) ltac:(apply CC_E_Ae_1; flia). }
    Unshelve.
    all: esc.
  - replace 2 with (S 1) by flia.
    replace (4 * q2 + 5) with (S (4 * q2 + 4)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH E (SAo n q2 1) ltac:(apply CC_E_Ao_1; flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    ...
    { rewrite to_side_SAe_succ_step.
      rewrite to_side_SAe_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SAe n q2 3)
          ltac:(applys_eq (CC_E_Ae_3_nonmax n q2); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SAe n q2 (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_E_Ae_long_nonmax n q2 k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    destruct k as [| k0].
    { rewrite to_side_SAo_succ_step.
      rewrite to_side_SAo_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SAo n q2 3)
          ltac:(applys_eq (CC_E_Ao_3_nonmax n q2); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SAo n q2 (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_E_Ao_long_nonmax n q2 k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    destruct k as [| k0].
    { rewrite to_side_SAe_succ_step.
      rewrite to_side_SBo_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SAe n n 3) ltac:(apply CC_E_Ae_3_diag). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SAe n n (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_E_Ae_long_diag_low n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * (2 * n + 3 + s2) + 4) with
    ...
    { replace (n + 1) with (S n) by flia.
      rewrite to_side_SPe_succ_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SAe n n (2 * (2 * n + 3 + 0) + 3))
          ltac:(applys_eq (CC_E_Ae_long_diag_low n (2 * n + 2)); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S s0) with (S (2 * s0 + 1)) by flia.
      rewrite to_side_SPe_succ_step.
      split_sideRLs_concat.
      { ih_by IH E (SAe n n (2 * (2 * n + 3 + S s0) + 3))
          ltac:(applys_eq (CC_E_Ae_long_diag_high n s0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    destruct k as [| k0].
    { rewrite to_side_SAo_succ_step.
      rewrite to_side_SBe_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SAo n n 3) ltac:(apply CC_E_Ao_3_diag). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SAo n n (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_E_Ao_long_diag_low n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * (2 * n + 5 + s2) + 4) with
    ...
    { rewrite to_side_SPo_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SAo n n (2 * (2 * n + 5 + 0) + 3))
          ltac:(applys_eq (CC_E_Ao_long_diag_low n (2 * n + 4)); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S s0) with (S (2 * s0 + 1)) by flia.
      rewrite to_side_SPo_succ_step.
      split_sideRLs_concat.
      { ih_by IH E (SAo n n (2 * (2 * n + 5 + S s0) + 3))
          ltac:(applys_eq (CC_E_Ao_long_diag_high n s0); flia). }
      Unshelve.
      all: esc. }
  - rewrite to_side_SBe_zero_step.
  ...
  - replace 1 with (S 0) by flia.
    rewrite to_side_SBe_succ_step.
    split_sideRLs_concat.
    { ih_by IH E (SBe n 0 0) ltac:(apply CC_E_Be0_0). }
    Unshelve.
    all: esc.
  - replace 1 with (S 0) by flia.
    rewrite to_side_SBo_succ_step.
    split_sideRLs_concat.
    { ih_by IH E (SBo n 0 0) ltac:(apply CC_E_Bo0_0). }
    Unshelve.
    all: esc.
  - replace 2 with (S 1) by flia.
    replace 3 with (S 2) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH E (SBe (n + 1) 0 1) ltac:(apply CC_E_Be0_1). }
    Unshelve.
    all: esc.
  - replace 2 with (S 1) by flia.
    replace 3 with (S 2) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH E (SBo (n + 1) 0 1) ltac:(apply CC_E_Bo0_1). }
    Unshelve.
    all: esc.
  - replace (2 * k + 3) with (S (2 * k + 2)) by flia.
    ...
    { rewrite to_side_SBe_succ_step.
      rewrite to_side_SAe_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SBe n 0 2) ltac:(apply CC_E_Be0_2). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SBe n 0 (S (2 * k0 + 1) + 2))
          ltac:(applys_eq (CC_E_Be0_even_tail n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 3) with (S (2 * k + 2)) by flia.
    destruct k as [| k0].
    { rewrite to_side_SBo_succ_step.
      rewrite to_side_SAo_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SBo n 0 2) ltac:(apply CC_E_Bo0_2). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SBo n 0 (S (2 * k0 + 1) + 2))
          ltac:(applys_eq (CC_E_Bo0_even_tail n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    rewrite to_side_SBe_succ_step.
    ...
    { rewrite to_side_SBe_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SBe (n + 1) 0 3) ltac:(apply CC_E_Be0_3). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      rewrite to_side_SBe_succ_step.
      split_sideRLs_concat.
      { ih_by IH E (SBe (n + 1) 0 (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_E_Be0_odd_tail n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    rewrite to_side_SBo_succ_step.
    ...
    { rewrite to_side_SBo_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SBo (n + 1) 0 3) ltac:(apply CC_E_Bo0_3). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      rewrite to_side_SBo_succ_step.
      split_sideRLs_concat.
      { ih_by IH E (SBo (n + 1) 0 (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_E_Bo0_odd_tail n k0); flia). }
      Unshelve.
      all: esc. }
  - rewrite to_side_SBe_zero_step.
    replace (7 + 4 * n) with (S (6 + 4 * n)) by flia.
  ...
  - replace 2 with (S 1) by flia.
    ...
    normalize_split_sideRLs_concat.
    { ih_by IH E (SBe n j 1)
        ltac:(apply CC_E_Be_pos_1; flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { unfold to_side.
    ...
    { replace 2 with (S 1) by flia.
      ...
      {
        eapply sideRLs_trans.
        { ih_by IH E (SBe (S n0) (S n0) 1)
            ltac:(applys_eq (CC_E_Be_succ_diag_1 n0); flia). }
  ...
  - replace 4 with (S 3) by flia.
    ...
    normalize_split_sideRLs_concat.
    { ih_by IH E (SBe n n 3) ltac:(apply CC_E_Be_diag_3). }
    Unshelve.
    all: esc.
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    ...
    { rewrite to_side_SBe_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SBe n j 3)
          ltac:(applys_eq (CC_E_Be_pos_3 n j); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      rewrite (to_side_SBe_succ_step n (j + 1) (2 * k0 + 1)).
      split_sideRLs_concat.
      { ih_by IH E (SBe n j (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_E_Be_pos_long n j k0); flia). }
      Unshelve.
      all: esc. }
  - destruct k as [| k0].
    { replace (2 * 0 + 6) with (S 5) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SBe n n 5) ltac:(apply CC_E_Be_diag_5). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0 + 6) with (S (2 * k0 + 7)) by flia.
      replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SBe n n (2 * k0 + 7))
          ltac:(applys_eq (CC_E_Be_diag_long_low n k0); flia). }
      Unshelve.
      all: esc. }
  - rewrite to_side_SBo_zero_step.
    replace (7 + 4 * n) with (S (6 + 4 * n)) by flia.
  ...
  - replace 2 with (S 1) by flia.
    replace (4 * j + 3) with (S (4 * j + 2)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH E (SBo n j 1)
        ltac:(apply CC_E_Bo_pos_1; flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { replace 2 with (S 1) by flia.
    ...
    { replace 2 with (S 1) by flia.
      ...
      {
        eapply sideRLs_trans.
        { ih_by IH E (SBo (S n0) (S n0) 1)
            ltac:(applys_eq (CC_E_Bo_succ_diag_1 n0); flia). }
  ...
  - replace 4 with (S 3) by flia.
    replace (4 * n + 5) with (S (4 * n + 4)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH E (SBo n n 3) ltac:(apply CC_E_Bo_diag_3). }
    Unshelve.
    all: esc.
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    ...
    { rewrite to_side_SBo_zero_step.
      split_sideRLs_concat.
      { ih_by IH E (SBo n j 3)
          ltac:(applys_eq (CC_E_Bo_pos_3 n j); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      rewrite (to_side_SBo_succ_step n (j + 1) (2 * k0 + 1)).
      split_sideRLs_concat.
      { ih_by IH E (SBo n j (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_E_Bo_pos_long n j k0); flia). }
      Unshelve.
      all: esc. }
  - destruct k as [| k0].
    { replace (2 * 0 + 6) with (S 5) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SBo n n 5) ltac:(apply CC_E_Bo_diag_5). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0 + 6) with (S (2 * k0 + 7)) by flia.
      replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SBo n n (2 * k0 + 7))
          ltac:(applys_eq (CC_E_Bo_diag_long_low n k0); flia). }
      Unshelve.
      all: esc. }
  - destruct k as [| k0].
    { replace (n + 2) with (S (n + 1)) by flia.
      ...
      normalize_split_sideRLs_concat.
      { eapply (IH (measure E (SBo (n + 1) 0 (5 + 4 * (n + 1))))).
        { replace (n + 2) with (S (n + 1)) by flia; measure_decr. }
        { flia. }
        { applys_eq (CC_E_Bo0_odd_tail n (2 * n + 2)); flia. } }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      replace (6 + 4 * n + S (2 * k0 + 1)) with (S (7 + 4 * n + 2 * k0)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH E (SPe (n + 2) (2 * k0 + 1))
          ltac:(applys_eq (CC_E_Pe_succ_odd n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 1) with (S (2 * k)) by flia.
    replace (4 + 4 * n + 2 * k) with (S (3 + 4 * n + 2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH E (SPe (n + 1) (2 * k))
        ltac:(applys_eq (CC_E_Pe_even n k); flia). }
    Unshelve.
    all: esc.
  - replace (n + 1) with (S n) by flia.
    ...
    rewrite to_side_SBe_succ_step.
    split_sideRLs_concat.
    { ih_by IH E (SBe (S n) 0 (5 + 4 * S n))
        ltac:(applys_eq (CC_E_Be0_odd_tail n (2 * n + 2)); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 1) with (S (2 * k)) by flia.
    replace (4 + 4 * n + 2 * k) with (S (3 + 4 * n + 2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH E (SPo n (2 * k))
        ltac:(applys_eq (CC_E_Po_even n k); flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { destruct q2 as [| q0].
...
Definition Bcfg (h : Side) : Q * tape :=
  to_side h {{{ ((C, []), R) }}} const S0.

Lemma B_to_C h :
  Bcfg h -[ tm ]->+ to_side h {{{ ((D, []), L) }}} (S1 >> const S0).
Proof.
  unfold Bcfg, tm.
  step1s.
Qed.
...
Lemma Btail_F_to_B s s' :
  ClosedCall F s F s' ->
  to_side s {{{ ((F, []), R) }}} (S1 >> const S0) -[ tm ]->+
  S1 >> S1 >> S1 >> to_side s' {{{ ((C, []), R) }}} const S0.
Proof.
  intro HF.
  eapply progress_trans.
  - apply marker1_F.
...
Lemma boundary_D0_Pe4_to_B n k :
  to_side (SPe n (4 * k)) {{{ ((E, []), R) }}} const S0 -[ tm ]->+
  Bcfg (SBe n k 2).
Proof.
  unfold Bcfg.
  cbn [to_side].
...
Lemma boundary_D0_Po4_to_B n k :
  to_side (SPo n (4 * k)) {{{ ((E, []), R) }}} const S0 -[ tm ]->+
  Bcfg (SBo n k 2).
Proof.
  unfold Bcfg.
  cbn [to_side].
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_D_Be_pos_long n j k); lia.
    + cbn [to_side].
