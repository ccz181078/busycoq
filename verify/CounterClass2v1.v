...
Definition tm := Eval compute in (TM_from_str "1RB1RD_1LC---_1LE0LD_0RE1LC_1RA1RF_1RE0LF").
...
Lemma sideRLs_D_Bo0_1 :
  sideRLs (flip tm) [((D, []), (B, []))] (to_side (SBo 0 0 1)) (to_side (SPo 0 3)).
Proof.
  cbn [to_side].
...
Lemma sideRLs_D_Bo0_5 :
  sideRLs (flip tm) [((D, []), (D, []))] (to_side (SBo 0 0 5)) (to_side (SPe 1 0)).
Proof.
  cbn [to_side].
...
| CC_C_Ao_zero n q :
    q <= n ->
    ClosedCall C (SAo n q 0) F (SAe n q (7 + 4 * n))
| CC_C_Ae_succ_zero n q :
    q <= n ->
    ClosedCall C (SAe (n + 1) q 0) F (SAo n q (7 + 4 * n))
| CC_C_Ae_succ_diag_zero n :
    ClosedCall C (SAe (n + 1) (n + 1) 0) F (SBe (n + 1) 0 (7 + 4 * n))
| CC_C_Ae_tail2 n q :
    q <= n ->
...
| CC_C_Ae_long_nonmax n q k :
    q < n ->
    k <= 4 * n + 3 ->
    ClosedCall C (SAe n q (2 * k + 4)) E (SAe n (q + 1) (2 * k))
| CC_C_Ao_long_nonmax n q k :
    q < n ->
    k <= 4 * n + 5 ->
    ClosedCall C (SAo n q (2 * k + 4)) E (SAo n (q + 1) (2 * k))
| CC_C_Ae_long_diag_low n k :
    k <= 2 * n + 2 ->
    ClosedCall C (SAe n n (2 * k + 4)) E (SBo n 0 (2 * k))
| CC_C_Ae_long_diag_high n s :
    s <= 2 * n ->
    ClosedCall C (SAe n n (2 * (2 * n + 3 + s) + 4)) E (SPe (n + 1) (2 * s))
| CC_C_Ao_long_diag_low n k :
    k <= 2 * n + 4 ->
    ClosedCall C (SAo n n (2 * k + 4)) E (SBe (n + 1) 0 (2 * k))
| CC_C_Ao_long_diag_high n s :
    s <= 2 * n ->
    ClosedCall C (SAo n n (2 * (2 * n + 5 + s) + 4)) E (SPo (n + 1) (2 * s))

| CC_C_Be0_0_succ n :
    ClosedCall C (SBe (n + 1) 0 0) F (SPe (n + 1) 1)
| CC_C_Bo_succ0_0 n :
    ClosedCall C (SBo (n + 1) 0 0) F (SBe (n + 1) 1 (7 + 4 * n))
| CC_C_Be0_1 n :
    ClosedCall C (SBe n 0 1) A (SBe n 0 1)
| CC_C_Bo0_1 n :
    ClosedCall C (SBo n 0 1) A (SBo n 0 1)
| CC_C_Be0_2_succ n :
    ClosedCall C (SBe (n + 1) 0 2) A (SPe (n + 1) 3)
| CC_C_Bo0_2 n :
    ClosedCall C (SBo (n + 1) 0 2) A (SPo (n + 1) 3)
| CC_C_Be0_odd_tail n k :
    k <= 2 * n + 1 ->
    ClosedCall C (SBe n 0 (2 * k + 3)) E (SAe n 0 (2 * k))
| CC_C_Bo0_odd_tail n k :
    k <= 2 * n + 1 ->
    ClosedCall C (SBo n 0 (2 * k + 3)) E (SAo n 0 (2 * k))
| CC_C_Be0_even_tail n k :
    k <= 2 * (n + 1) ->
    ClosedCall C (SBe (n + 1) 0 (2 * k + 4)) E (SBe (n + 1) 1 (2 * k))
| CC_C_Bo0_even_tail n k :
    k <= 2 * (n + 1) ->
    ClosedCall C (SBo (n + 1) 0 (2 * k + 4)) E (SBo (n + 1) 1 (2 * k))

| CC_C_Be_succ_pos_zero n j :
    1 <= j ->
    j < n + 1 ->
    ClosedCall C (SBe (n + 1) j 0) F (SBo n j (7 + 4 * n))
| CC_C_Be_diag_zero n :
    ClosedCall C (SBe n n 0) F (SBe n 0 (4 * n + 1))
| CC_C_Be_pos_tail2 n j :
    1 <= j ->
    j < n ->
    ClosedCall C (SBe n j 2) A (SPe n (4 * j + 3))
| CC_C_Be_diag_tail2 n :
    ClosedCall C (SBe n n 2) F (SBe n 0 (4 * n + 3))
| CC_C_Be_diag_tail4 n :
    ClosedCall C (SBe n n 4) A (SBe n 0 (4 * n + 5))
| CC_C_Be_pos_long n j k :
    1 <= j ->
    j < n ->
    k <= 2 * n + 1 ->
    ClosedCall C (SBe n j (2 * k + 4)) E (SBe n (j + 1) (2 * k))
| CC_C_Be_diag_long_low n k :
    k <= 2 * n ->
    ClosedCall C (SBe n n (2 * k + 6)) E (SBo n 0 (2 * k))
| CC_C_Bo_succ_pos_zero n j :
    1 <= j ->
    j < n + 1 ->
    ClosedCall C (SBo (n + 1) j 0) F (SBe (n + 1) (j + 1) (7 + 4 * n))
| CC_C_Bo_diag_zero n :
    ClosedCall C (SBo n n 0) F (SBo n 0 (4 * n + 1))
| CC_C_Bo_pos_tail2 n j :
    1 <= j ->
    j < n ->
    ClosedCall C (SBo n j 2) A (SPo n (4 * j + 3))
| CC_C_Bo_diag_tail2 n :
    ClosedCall C (SBo n n 2) F (SAe n n (7 + 4 * n))
| CC_C_Bo_diag_tail4 n :
    ClosedCall C (SBo n n 4) A (SBo n 0 (4 * n + 5))
| CC_C_Bo_pos_long n j k :
    1 <= j ->
    j < n ->
    k <= 2 * n + 3 ->
    ClosedCall C (SBo n j (2 * k + 4)) E (SBo n (j + 1) (2 * k))
| CC_C_Bo_diag_long_low n k :
    k <= 2 * n + 2 ->
    ClosedCall C (SBo n n (2 * k + 6)) E (SBe (n + 1) 0 (2 * k))

| CC_C_Pe_succ_even n k :
    k <= 2 ->
    ClosedCall C (SPe (n + 2) (2 * k)) E (SBo (n + 1) 1 (6 + 4 * n + 2 * k))
| CC_C_Pe_odd n k :
    k <= 2 * n + 3 ->
    ClosedCall C (SPe (n + 1) (2 * k + 1)) E (SAo n 0 (4 + 4 * n + 2 * k))
| CC_C_Po_even n k :
    k = 0 ->
    ClosedCall C (SPo (n + 1) (2 * k)) E (SBe (n + 1) 1 (6 + 4 * n + 2 * k))
| CC_C_Po_odd n k :
    k <= 2 * n + 1 ->
    ClosedCall C (SPo n (2 * k + 1)) E (SAe n 0 (4 + 4 * n + 2 * k))

| CC_D_Ae_1 n q :
    q <= n ->
    ClosedCall D (SAe n q 1) E (SBe n 0 (4 * q + 4))
| CC_D_Ao_1 n q :
    q <= n ->
    ClosedCall D (SAo n q 1) E (SBo n 0 (4 * q + 4))
| CC_D_Ae_3_nonmax n q :
    q < n ->
    ClosedCall D (SAe n q 3) D (SBe n 0 (4 * q + 6))
| CC_D_Ae_3_diag n :
    ClosedCall D (SAe n n 3) D (SPo n 0)
| CC_D_Ao_3_nonmax n q :
    q < n ->
    ClosedCall D (SAo n q 3) D (SBo n 0 (4 * q + 6))
| CC_D_Ao_3_diag n :
    ClosedCall D (SAo n n 3) D (SPe (n + 1) 0)
| CC_D_Ae_long_nonmax n q k :
    q < n ->
    k <= 4 * n + 2 ->
    ClosedCall D (SAe n q (2 * k + 5)) F (SAe n (q + 1) (2 * k + 1))
| CC_D_Ao_long_nonmax n q k :
    q < n ->
    k <= 4 * n + 4 ->
    ClosedCall D (SAo n q (2 * k + 5)) F (SAo n (q + 1) (2 * k + 1))
| CC_D_Ae_long_diag_low n k :
    k <= 2 * n + 2 ->
    ClosedCall D (SAe n n (2 * k + 5)) F (SBo n 0 (2 * k + 1))
| CC_D_Ae_long_diag_high n s :
    s < 2 * n ->
    ClosedCall D (SAe n n (2 * (2 * n + 3 + s) + 5)) F (SPe (n + 1) (2 * s + 1))
| CC_D_Ao_long_diag_low n k :
    k <= 2 * n + 4 ->
    ClosedCall D (SAo n n (2 * k + 5)) F (SBe (n + 1) 0 (2 * k + 1))
| CC_D_Ao_long_diag_high n s :
    s < 2 * n ->
    ClosedCall D (SAo n n (2 * (2 * n + 5 + s) + 5)) F (SPo (n + 1) (2 * s + 1))

| CC_D_Be0_0 n :
    ClosedCall D (SBe n 0 0) E (SBe n 0 0)
| CC_D_Bo0_0 n :
    ClosedCall D (SBo n 0 0) E (SBo n 0 0)
| CC_D_Be0_1 n :
    ClosedCall D (SBe (n + 1) 0 1) E (SPe (n + 1) 2)
| CC_D_Bo0_1 n :
    ClosedCall D (SBo (n + 1) 0 1) E (SPo (n + 1) 2)
| CC_D_Be0_2 n :
    ClosedCall D (SBe n 0 2) D (SBe n 0 2)
| CC_D_Bo0_2 n :
    ClosedCall D (SBo n 0 2) D (SBo n 0 2)
| CC_D_Be0_3 n :
    ClosedCall D (SBe (n + 1) 0 3) D (SPe (n + 1) 4)
| CC_D_Bo0_3 n :
    ClosedCall D (SBo (n + 1) 0 3) D (SPo (n + 1) 4)
| CC_D_Be0_even_tail n k :
    k <= 2 * n ->
    ClosedCall D (SBe n 0 (2 * k + 4)) F (SAe n 0 (2 * k + 1))
| CC_D_Bo0_even_tail n k :
    k <= 2 * n ->
    ClosedCall D (SBo n 0 (2 * k + 4)) F (SAo n 0 (2 * k + 1))
| CC_D_Be0_odd_tail n k :
    k <= 2 * (n + 1) ->
    ClosedCall D (SBe (n + 1) 0 (2 * k + 5)) F (SBe (n + 1) 1 (2 * k + 1))
| CC_D_Bo0_odd_tail n k :
    k <= 2 * (n + 1) ->
    ClosedCall D (SBo (n + 1) 0 (2 * k + 5)) F (SBo (n + 1) 1 (2 * k + 1))

| CC_D_Be_pos_1 n j :
    1 <= j ->
    j < n ->
    ClosedCall D (SBe n j 1) E (SPe n (4 * j + 2))
| CC_D_Be_succ_diag_1 n :
    ClosedCall D (SBe (n + 1) (n + 1) 1) B (SAo n n (10 + 4 * n))
| CC_D_Be_pos_3 n j :
    1 <= j ->
    j < n ->
    ClosedCall D (SBe n j 3) D (SPe n (4 * j + 4))
| CC_D_Be_diag_3 n :
    ClosedCall D (SBe n n 3) E (SBe n 0 (4 * n + 4))
| CC_D_Be_diag_5 n :
    ClosedCall D (SBe n n 5) D (SPo n 0)
| CC_D_Be_pos_long n j k :
    1 <= j ->
    j < n ->
    k <= 2 * n ->
    ClosedCall D (SBe n j (2 * k + 5)) F (SBe n (j + 1) (2 * k + 1))
| CC_D_Be_diag_long_low n k :
    k < 2 * n ->
    ClosedCall D (SBe n n (2 * k + 7)) F (SBo n 0 (2 * k + 1))
| CC_D_Bo_pos_1 n j :
    1 <= j ->
    j < n ->
    ClosedCall D (SBo n j 1) E (SPo n (4 * j + 2))
| CC_D_Bo_succ_diag_1 n :
    ClosedCall D (SBo (n + 1) (n + 1) 1) B (SAe (n + 1) n (10 + 4 * (n + 1)))
| CC_D_Bo_pos_3 n j :
    1 <= j ->
    j < n ->
    ClosedCall D (SBo n j 3) D (SPo n (4 * j + 4))
| CC_D_Bo_diag_3 n :
    ClosedCall D (SBo n n 3) E (SBo n 0 (4 * n + 4))
| CC_D_Bo_diag_5 n :
    ClosedCall D (SBo n n 5) D (SPe (n + 1) 0)
| CC_D_Bo_pos_long n j k :
    1 <= j ->
    j < n ->
    k <= 2 * n + 2 ->
    ClosedCall D (SBo n j (2 * k + 5)) F (SBo n (j + 1) (2 * k + 1))
| CC_D_Bo_diag_long_low n k :
    k <= 2 * n + 1 ->
    ClosedCall D (SBo n n (2 * k + 7)) F (SBe (n + 1) 0 (2 * k + 1))

| CC_D_Pe_even n k :
    k <= 2 * n + 3 ->
    ClosedCall D (SPe (n + 1) (2 * k)) F (SAo n 0 (3 + 4 * n + 2 * k))
| CC_D_Pe_succ_odd n k :
    k <= 1 ->
    ClosedCall D (SPe (n + 2) (2 * k + 1)) F (SBo (n + 1) 1 (7 + 4 * n + 2 * k))
| CC_D_Po_even n k :
    k <= 2 * n + 1 ->
    ClosedCall D (SPo n (2 * k)) F (SAe n 0 (3 + 4 * n + 2 * k))

| CC_E_Pe n k :
    k <= n ->
    ClosedCall E (SPe n (4 * k)) F (SPe n (4 * k))
| CC_E_Po n k :
    k <= n ->
    ClosedCall E (SPo n (4 * k)) F (SPo n (4 * k))
| CC_E_Be n k :
    k <= n ->
    ClosedCall E (SBe n 0 (4 * k + 2)) F (SBe n 0 (4 * k + 2))
| CC_E_Bo n k :
    k <= n ->
    ClosedCall E (SBo n 0 (4 * k + 2)) F (SBo n 0 (4 * k + 2))
...
Proof.
  ...
  - replace (7 + 4 * n) with (S (6 + 4 * n)) by flia.
      normalize_split_sideRLs_concat.
      {
        ...
        { eapply (IH (measure E (SBo n 0 (4 * q2 + 2)))).
          { unfold measure, side_measure, class_rank, skelO_measure.
            cbn [skelE_measure skelO_measure].
            flia. }
          { reflexivity. }
          { applys_eq (CC_E_Bo n q2); flia. } }
        destruct q2 as [| q0].
        { eapply sideRLs_trans.
          ...
          eapply (IH (measure C (SPo n 3))).
          { unfold measure, side_measure, class_rank, skelO_measure.
            cbn [skelE_measure skelO_measure].
            flia. }
          { flia. }
          { applys_eq (CC_C_Po_odd n 1); flia. } }
        { eapply sideRLs_trans.
          ...
          eapply (IH (measure C (SAe n q0 (10 + 4 * n)))).
          { unfold measure, side_measure, class_rank, skelO_measure.
            cbn [skelE_measure skelO_measure].
            flia. }
          { flia. }
          { applys_eq (CC_C_Ae_long_nonmax n q0 (2 * n + 3)); flia. } }
      }
      Unshelve.
      all: esc.
  - replace (7 + 4 * n) with (S (6 + 4 * n)) by flia.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH E (SBe (n + 1) 0 (4 * q2 + 2))
          ltac:(applys_eq (CC_E_Be (n + 1) q2); flia). }
      destruct q2 as [| qn].
      { eapply sideRLs_trans.
        { ih_by IH F (SBe (n + 1) 0 (4 * 0 + 2))
            ltac:(apply CC_F_Be_small2). }
        ih_by IH C (SPe (n + 1) (4 * 0 + 3))
          ltac:(applys_eq (CC_C_Pe_odd n 1); flia). }
      { eapply sideRLs_trans.
        { ih_by IH F (SBe (n + 1) 0 (4 * S qn + 2))
            ltac:(applys_eq (CC_F_Be_A_range_6 n 0 qn); flia). }
        eapply (IH (measure C (SAo n qn (10 + 4 * n)))).
        { measure_decr. }
        { flia. }
        { applys_eq (CC_C_Ao_long_nonmax n qn (2 * n + 3)); flia. } }
    }
    Unshelve.
    all: esc.
  - replace (7 + 4 * n) with (S (6 + 4 * n)) by flia.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH E (SBe (n + 1) 0 (4 * (n + 1) + 2))
          ltac:(applys_eq (CC_E_Be (n + 1) (n + 1)); flia). }
      eapply sideRLs_trans.
      { ih_by IH F (SBe (n + 1) 0 (4 * (n + 1) + 2))
          ltac:(applys_eq (CC_F_Be_A_range_6 n 0 n); flia). }
      ih_by IH C (SAo n n (10 + 4 * n + 4 * 0))
        ltac:(applys_eq (CC_C_Ao_long_diag_low n (2 * n + 3)); flia).
    }
    Unshelve.
    all: esc.
  - replace 2 with (S 1) by flia.
    ...
    normalize_split_sideRLs_concat.
    { ih_by IH D (SAe n q2 1) ltac:(apply CC_D_Ae_1; flia). }
    Unshelve.
    all: esc.
  - replace 2 with (S 1) by flia.
    replace (4 * q2 + 5) with (S (4 * q2 + 4)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH D (SAo n q2 1) ltac:(apply CC_D_Ao_1; flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    ...
    { rewrite to_side_SAe_succ_step.
      rewrite to_side_SAe_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SAe n q2 3)
          ltac:(applys_eq (CC_D_Ae_3_nonmax n q2); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SAe n q2 (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_D_Ae_long_nonmax n q2 k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    destruct k as [| k0].
    { rewrite to_side_SAo_succ_step.
      rewrite to_side_SAo_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SAo n q2 3)
          ltac:(applys_eq (CC_D_Ao_3_nonmax n q2); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SAo n q2 (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_D_Ao_long_nonmax n q2 k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    destruct k as [| k0].
    { rewrite to_side_SAe_succ_step.
      rewrite to_side_SBo_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SAe n n 3) ltac:(apply CC_D_Ae_3_diag). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SAe n n (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_D_Ae_long_diag_low n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * (2 * n + 3 + s2) + 4) with
    ...
    { replace (n + 1) with (S n) by flia.
      rewrite to_side_SPe_succ_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SAe n n (2 * (2 * n + 3 + 0) + 3))
          ltac:(applys_eq (CC_D_Ae_long_diag_low n (2 * n + 2)); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S s0) with (S (2 * s0 + 1)) by flia.
      rewrite to_side_SPe_succ_step.
      split_sideRLs_concat.
      { ih_by IH D (SAe n n (2 * (2 * n + 3 + S s0) + 3))
          ltac:(applys_eq (CC_D_Ae_long_diag_high n s0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    destruct k as [| k0].
    { rewrite to_side_SAo_succ_step.
      rewrite to_side_SBe_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SAo n n 3) ltac:(apply CC_D_Ao_3_diag). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SAo n n (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_D_Ao_long_diag_low n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * (2 * n + 5 + s2) + 4) with
    ...
    { rewrite to_side_SPo_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SAo n n (2 * (2 * n + 5 + 0) + 3))
          ltac:(applys_eq (CC_D_Ao_long_diag_low n (2 * n + 4)); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S s0) with (S (2 * s0 + 1)) by flia.
      rewrite to_side_SPo_succ_step.
      split_sideRLs_concat.
      { ih_by IH D (SAo n n (2 * (2 * n + 5 + S s0) + 3))
          ltac:(applys_eq (CC_D_Ao_long_diag_high n s0); flia). }
      Unshelve.
      all: esc. }
  - rewrite to_side_SBe_zero_step.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH E (SPe (n + 1) 0) ltac:(applys_eq (CC_E_Pe (n + 1) 0); flia). }
      eapply sideRLs_trans.
      { ih_by IH F (SPe (n + 1) 0) ltac:(apply CC_F_Pe_succ_0). }
      ih_by IH C (SAe n n (10 + 4 * n))
        ltac:(applys_eq (CC_C_Ae_long_diag_high n 0); flia).
    }
    Unshelve.
    all: esc.
  - rewrite to_side_SBo_zero_step.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH E (SPo (n + 1) 0) ltac:(applys_eq (CC_E_Po (n + 1) 0); flia). }
      eapply sideRLs_trans.
      { ih_by IH F (SPo (n + 1) 0) ltac:(apply CC_F_Po_0). }
      ih_by IH C (SPo (n + 1) 0)
        ltac:(applys_eq (CC_C_Po_even n 0); flia).
    }
    Unshelve.
    all: esc.
  - replace 1 with (S 0) by flia.
    rewrite to_side_SBe_succ_step.
    split_sideRLs_concat.
    { ih_by IH D (SBe n 0 0) ltac:(apply CC_D_Be0_0). }
    Unshelve.
    all: esc.
  - replace 1 with (S 0) by flia.
    rewrite to_side_SBo_succ_step.
    split_sideRLs_concat.
    { ih_by IH D (SBo n 0 0) ltac:(apply CC_D_Bo0_0). }
    Unshelve.
    all: esc.
  - replace 2 with (S 1) by flia.
    replace 3 with (S 2) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH D (SBe (n + 1) 0 1) ltac:(apply CC_D_Be0_1). }
    Unshelve.
    all: esc.
  - replace 2 with (S 1) by flia.
    replace 3 with (S 2) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH D (SBo (n + 1) 0 1) ltac:(apply CC_D_Bo0_1). }
    Unshelve.
    all: esc.
  - replace (2 * k + 3) with (S (2 * k + 2)) by flia.
    ...
    { rewrite to_side_SBe_succ_step.
      rewrite to_side_SAe_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SBe n 0 2) ltac:(apply CC_D_Be0_2). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SBe n 0 (S (2 * k0 + 1) + 2))
          ltac:(applys_eq (CC_D_Be0_even_tail n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 3) with (S (2 * k + 2)) by flia.
    destruct k as [| k0].
    { rewrite to_side_SBo_succ_step.
      rewrite to_side_SAo_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SBo n 0 2) ltac:(apply CC_D_Bo0_2). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SBo n 0 (S (2 * k0 + 1) + 2))
          ltac:(applys_eq (CC_D_Bo0_even_tail n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    rewrite to_side_SBe_succ_step.
    ...
    { rewrite to_side_SBe_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SBe (n + 1) 0 3) ltac:(apply CC_D_Be0_3). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      rewrite to_side_SBe_succ_step.
      split_sideRLs_concat.
      { ih_by IH D (SBe (n + 1) 0 (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_D_Be0_odd_tail n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    rewrite to_side_SBo_succ_step.
    ...
    { rewrite to_side_SBo_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SBo (n + 1) 0 3) ltac:(apply CC_D_Bo0_3). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      rewrite to_side_SBo_succ_step.
      split_sideRLs_concat.
      { ih_by IH D (SBo (n + 1) 0 (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_D_Bo0_odd_tail n k0); flia). }
      Unshelve.
      all: esc. }
  - rewrite to_side_SBe_zero_step.
    replace (7 + 4 * n) with (S (6 + 4 * n)) by flia.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH E (SPe (n + 1) (4 * j)) ltac:(applys_eq (CC_E_Pe (n + 1) j); flia). }
      destruct j as [| [| j0]].
      { exfalso; flia. }
      { destruct n as [| n0].
        { exfalso; flia. }
        ...
        ih_by IH C (SPe (S n0 + 1) 4)
          ltac:(applys_eq (CC_C_Pe_succ_even n0 2); flia). }
      { eapply sideRLs_trans.
        { ih_by IH F (SPe (n + 1) (4 * S (S j0)))
            ltac:(applys_eq (CC_F_Pe_large_4 n j0); flia). }
        ih_by IH C (SBo n (j0 + 1) (10 + 4 * n))
          ltac:(applys_eq (CC_C_Bo_pos_long n (j0 + 1) (2 * n + 3)); flia). }
    }
    Unshelve.
    all: esc.
  - destruct n as [| [| n0]].
    ...
    { rewrite to_side_SBe_zero_step.
      ...
      {
        eapply sideRLs_trans.
        { ih_by IH E (SPe (S (S n0)) (4 * S (S n0)))
            ltac:(applys_eq (CC_E_Pe (S (S n0)) (S (S n0))); flia). }
        eapply sideRLs_trans.
        { ih_by IH F (SPe (S (S n0)) (4 * S (S n0)))
            ltac:(applys_eq (CC_F_Pe_large_4 (n0 + 1) n0); flia). }
        ih_by IH C (SBo (n0 + 1) (n0 + 1) (10 + 4 * (n0 + 1)))
          ltac:(applys_eq (CC_C_Bo_diag_long_low (n0 + 1) (2 * (n0 + 1) + 2)); flia).
      }
      Unshelve.
      all: esc. }
  - replace 2 with (S 1) by flia.
    ...
    normalize_split_sideRLs_concat.
    { ih_by IH D (SBe n j 1)
        ltac:(apply CC_D_Be_pos_1; flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { unfold to_side.
    ...
    { replace 2 with (S 1) by flia.
      ...
      {
        eapply sideRLs_trans.
        { ih_by IH D (SBe (S n0) (S n0) 1)
            ltac:(applys_eq (CC_D_Be_succ_diag_1 n0); flia). }
        ih_by IH C (SAo n0 n0 (10 + 4 * n0))
          ltac:(applys_eq (CC_C_Ao_long_diag_low n0 (2 * n0 + 3)); flia).
      }
      Unshelve.
      all: esc. }
  - replace 4 with (S 3) by flia.
    ...
    normalize_split_sideRLs_concat.
    { ih_by IH D (SBe n n 3) ltac:(apply CC_D_Be_diag_3). }
    Unshelve.
    all: esc.
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    ...
    { rewrite to_side_SBe_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SBe n j 3)
          ltac:(applys_eq (CC_D_Be_pos_3 n j); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      rewrite (to_side_SBe_succ_step n (j + 1) (2 * k0 + 1)).
      split_sideRLs_concat.
      { ih_by IH D (SBe n j (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_D_Be_pos_long n j k0); flia). }
      Unshelve.
      all: esc. }
  - destruct k as [| k0].
    { replace (2 * 0 + 6) with (S 5) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SBe n n 5) ltac:(apply CC_D_Be_diag_5). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0 + 6) with (S (2 * k0 + 7)) by flia.
      replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SBe n n (2 * k0 + 7))
          ltac:(applys_eq (CC_D_Be_diag_long_low n k0); flia). }
      Unshelve.
      all: esc. }
  - rewrite to_side_SBo_zero_step.
    replace (7 + 4 * n) with (S (6 + 4 * n)) by flia.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH E (SPo (n + 1) (4 * j)) ltac:(applys_eq (CC_E_Po (n + 1) j); flia). }
      eapply sideRLs_trans.
      { ih_by IH F (SPo (n + 1) (4 * j))
          ltac:(applys_eq (CC_F_Po_pos_4 n (j - 1)); flia). }
      ih_by IH C (SBe (n + 1) (j - 1 + 1) (10 + 4 * n))
        ltac:(applys_eq (CC_C_Be_pos_long (n + 1) j (2 * n + 3)); flia).
    }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    ...
    { rewrite to_side_SBo_zero_step.
      ...
      {
        eapply sideRLs_trans.
        { ih_by IH E (SPo (S n0) (4 * S n0))
            ltac:(applys_eq (CC_E_Po (S n0) (S n0)); flia). }
        eapply sideRLs_trans.
        { ih_by IH F (SPo (S n0) (4 * S n0))
            ltac:(applys_eq (CC_F_Po_pos_4 n0 n0); flia). }
        ih_by IH C (SBe (n0 + 1) (n0 + 1) (10 + 4 * n0))
          ltac:(applys_eq (CC_C_Be_diag_long_low (S n0) (2 * S n0)); flia).
      }
      Unshelve.
      all: esc. }
  - replace 2 with (S 1) by flia.
    replace (4 * j + 3) with (S (4 * j + 2)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH D (SBo n j 1)
        ltac:(apply CC_D_Bo_pos_1; flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { replace 2 with (S 1) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SPo 0 3) ltac:(applys_eq (CC_C_Po_odd 0 1); flia).
      }
      Unshelve.
      all: esc. }
    { replace 2 with (S 1) by flia.
      ...
      {
        eapply sideRLs_trans.
        { ih_by IH D (SBo (S n0) (S n0) 1)
            ltac:(applys_eq (CC_D_Bo_succ_diag_1 n0); flia). }
        ih_by IH C (SAe (n0 + 1) n0 (10 + 4 * (n0 + 1)))
          ltac:(applys_eq (CC_C_Ae_long_nonmax (S n0) n0 (2 * n0 + 5)); flia).
      }
      Unshelve.
      all: esc. }
  - replace 4 with (S 3) by flia.
    replace (4 * n + 5) with (S (4 * n + 4)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH D (SBo n n 3) ltac:(apply CC_D_Bo_diag_3). }
    Unshelve.
    all: esc.
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    ...
    { rewrite to_side_SBo_zero_step.
      split_sideRLs_concat.
      { ih_by IH D (SBo n j 3)
          ltac:(applys_eq (CC_D_Bo_pos_3 n j); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      rewrite (to_side_SBo_succ_step n (j + 1) (2 * k0 + 1)).
      split_sideRLs_concat.
      { ih_by IH D (SBo n j (S (2 * k0 + 1) + 3))
          ltac:(applys_eq (CC_D_Bo_pos_long n j k0); flia). }
      Unshelve.
      all: esc. }
  - destruct k as [| k0].
    { replace (2 * 0 + 6) with (S 5) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SBo n n 5) ltac:(apply CC_D_Bo_diag_5). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0 + 6) with (S (2 * k0 + 7)) by flia.
      replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SBo n n (2 * k0 + 7))
          ltac:(applys_eq (CC_D_Bo_diag_long_low n k0); flia). }
      Unshelve.
      all: esc. }
  - destruct k as [| k0].
    { replace (n + 2) with (S (n + 1)) by flia.
      ...
      normalize_split_sideRLs_concat.
      { eapply (IH (measure D (SBo (n + 1) 0 (5 + 4 * (n + 1))))).
        { replace (n + 2) with (S (n + 1)) by flia; measure_decr. }
        { flia. }
        { applys_eq (CC_D_Bo0_odd_tail n (2 * n + 2)); flia. } }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      replace (6 + 4 * n + S (2 * k0 + 1)) with (S (7 + 4 * n + 2 * k0)) by flia.
      normalize_split_sideRLs_concat.
      { ih_by IH D (SPe (n + 2) (2 * k0 + 1))
          ltac:(applys_eq (CC_D_Pe_succ_odd n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 1) with (S (2 * k)) by flia.
    replace (4 + 4 * n + 2 * k) with (S (3 + 4 * n + 2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH D (SPe (n + 1) (2 * k))
        ltac:(applys_eq (CC_D_Pe_even n k); flia). }
    Unshelve.
    all: esc.
  - replace (n + 1) with (S n) by flia.
    ...
    rewrite to_side_SBe_succ_step.
    split_sideRLs_concat.
    { ih_by IH D (SBe (S n) 0 (5 + 4 * S n))
        ltac:(applys_eq (CC_D_Be0_odd_tail n (2 * n + 2)); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 1) with (S (2 * k)) by flia.
    replace (4 + 4 * n + 2 * k) with (S (3 + 4 * n + 2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH D (SPo n (2 * k))
        ltac:(applys_eq (CC_D_Po_even n k); flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { destruct q2 as [| q0].
    ...
    normalize_split_sideRLs_concat.
    {
      ...
      { subst q2.
        eapply sideRLs_trans.
        { ih_by IH C (SAe (S n0) (S n0) 0)
            ltac:(applys_eq (CC_C_Ae_succ_diag_zero n0); flia). }
        ih_by IH F (SBe (n0 + 1) 0 (7 + 4 * n0))
          ltac:(applys_eq (CC_F_Be_past_3_j0 n0 0); flia). }
      { eapply sideRLs_trans.
        { ih_by IH C (SAe (S n0) q2 0)
            ltac:(applys_eq (CC_C_Ae_succ_zero n0 q2); flia). }
  ...
  - replace 1 with (S 0) by flia.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH C (SAo n q2 0)
          ltac:(applys_eq (CC_C_Ao_zero n q2); flia). }
  ...
  - replace 3 with (S 2) by flia.
    ...
    { ih_by IH C (SAe n q2 2)
        ltac:(apply CC_C_Ae_tail2; flia). }
    Unshelve.
    all: esc.
  - replace 3 with (S 2) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SAe n n 2)
        ltac:(applys_eq (CC_C_Ae_tail2 n n); flia). }
    Unshelve.
    all: esc.
  - replace 3 with (S 2) by flia.
    replace (4 * q2 + 6) with (S (4 * q2 + 5)) by flia.
  ...
  - replace 3 with (S 2) by flia.
    ...
    rewrite to_side_SPe_succ_zero_step.
    split_sideRLs_concat.
    { ih_by IH C (SAo n n 2)
        ltac:(applys_eq (CC_C_Ao_tail2 n n); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 5) with (S (2 * k + 4)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SAe n q2 (2 * k + 4))
        ltac:(applys_eq (CC_C_Ae_long_nonmax n q2 k); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 5) with (S (2 * k + 4)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SAo n q2 (2 * k + 4))
        ltac:(applys_eq (CC_C_Ao_long_nonmax n q2 k); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 5) with (S (2 * k + 4)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SAe n n (2 * k + 4))
        ltac:(applys_eq (CC_C_Ae_long_diag_low n k); flia). }
    Unshelve.
    all: esc.
  - replace (2 * (2 * n + 3 + s2) + 5) with (S (2 * (2 * n + 3 + s2) + 4)) by flia.
    replace (2 * s2 + 1) with (S (2 * s2)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SAe n n (2 * (2 * n + 3 + s2) + 4))
        ltac:(applys_eq (CC_C_Ae_long_diag_high n s2); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 5) with (S (2 * k + 4)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SAo n n (2 * k + 4))
        ltac:(applys_eq (CC_C_Ao_long_diag_low n k); flia). }
    Unshelve.
    all: esc.
  - replace (2 * (2 * n + 5 + s2) + 5) with (S (2 * (2 * n + 5 + s2) + 4)) by flia.
    replace (2 * s2 + 1) with (S (2 * s2)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SAo n n (2 * (2 * n + 5 + s2) + 4))
        ltac:(applys_eq (CC_C_Ao_long_diag_high n s2); flia). }
    Unshelve.
    all: esc.
  - unfold to_side.
    cbn.
  ...
  - replace 1 with (S 0) by flia.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH C (SBe (n + 1) 0 0)
          ltac:(applys_eq (CC_C_Be0_0_succ n); flia). }
  ...
  - destruct n as [| n0].
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH C (SBo (S n0 + 1) 0 0)
          ltac:(applys_eq (CC_C_Bo_succ0_0 (S n0)); flia). }
  ...
  - replace 2 with (S 1) by flia.
    ...
    split_sideRLs_concat.
    { ih_by IH C (SBe n 0 1)
        ltac:(apply CC_C_Be0_1). }
    Unshelve.
    all: esc.
  - replace 2 with (S 1) by flia.
    rewrite (to_side_SBo_succ_step n 0 1).
    split_sideRLs_concat.
    { ih_by IH C (SBo n 0 1)
        ltac:(apply CC_C_Bo0_1). }
    Unshelve.
    all: esc.
  - replace 3 with (S 2) by flia.
    ...
    split_sideRLs_concat.
    { ih_by IH C (SBe (n + 1) 0 2)
        ltac:(apply CC_C_Be0_2_succ). }
    Unshelve.
    all: esc.
  - replace 3 with (S 2) by flia.
    ...
    split_sideRLs_concat.
    { ih_by IH C (SBo (n + 1) 0 2)
        ltac:(apply CC_C_Bo0_2). }
    Unshelve.
    all: esc.
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBe n 0 (2 * k + 3))
        ltac:(applys_eq (CC_C_Be0_odd_tail n k); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 4) with (S (2 * k + 3)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBo n 0 (2 * k + 3))
        ltac:(applys_eq (CC_C_Bo0_odd_tail n k); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 5) with (S (2 * k + 4)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBe (n + 1) 0 (2 * k + 4))
        ltac:(applys_eq (CC_C_Be0_even_tail n k); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 5) with (S (2 * k + 4)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBo (n + 1) 0 (2 * k + 4))
        ltac:(applys_eq (CC_C_Bo0_even_tail n k); flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { exfalso; flia. }
    ...
    {
      eapply sideRLs_trans.
    { ih_by IH C (SBe (S n0) (S j0) 0)
          ltac:(applys_eq (CC_C_Be_succ_pos_zero n0 (S j0)); flia). }
  ...
  - replace 1 with (S 0) by flia.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH C (SBe (S n) (S n) 0)
          ltac:(applys_eq (CC_C_Be_diag_zero (S n)); flia). }
  ...
  - replace 3 with (S 2) by flia.
    ...
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBe n j 2)
        ltac:(apply CC_C_Be_pos_tail2; flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { unfold to_side.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH C (SBe (S n0) (S n0) 2)
          ltac:(applys_eq (CC_C_Be_diag_tail2 (S n0)); flia). }
  ...
  - replace 5 with (S 4) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBe n n 4)
        ltac:(applys_eq (CC_C_Be_diag_tail4 n); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 5) with (S (2 * k + 4)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBe n j (2 * k + 4))
        ltac:(applys_eq (CC_C_Be_pos_long n j k); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 7) with (S (2 * k + 6)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBe n n (2 * k + 6))
        ltac:(applys_eq (CC_C_Be_diag_long_low n k); flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { exfalso; flia. }
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH C (SBo (S n0) (S j0) 0)
          ltac:(applys_eq (CC_C_Bo_succ_pos_zero n0 (S j0)); flia). }
  ...
  - replace 1 with (S 0) by flia.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH C (SBo (S n) (S n) 0)
          ltac:(applys_eq (CC_C_Bo_diag_zero (S n)); flia). }
  ...
  - replace 3 with (S 2) by flia.
    replace (4 * j + 4) with (S (4 * j + 3)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBo n j 2)
        ltac:(apply CC_C_Bo_pos_tail2; flia). }
    Unshelve.
    all: esc.
  - destruct n as [| n0].
    { unfold to_side.
    ...
    {
      eapply sideRLs_trans.
      { ih_by IH C (SBo (S n0) (S n0) 2)
          ltac:(applys_eq (CC_C_Bo_diag_tail2 (S n0)); flia). }
  ...
  - replace 5 with (S 4) by flia.
    ...
    rewrite to_side_SPe_succ_zero_step.
    split_sideRLs_concat.
    { ih_by IH C (SBo n n 4)
        ltac:(applys_eq (CC_C_Bo_diag_tail4 n); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 5) with (S (2 * k + 4)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBo n j (2 * k + 4))
        ltac:(applys_eq (CC_C_Bo_pos_long n j k); flia). }
    Unshelve.
    all: esc.
  - replace (2 * k + 7) with (S (2 * k + 6)) by flia.
    replace (2 * k + 1) with (S (2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SBo n n (2 * k + 6))
        ltac:(applys_eq (CC_C_Bo_diag_long_low n k); flia). }
    Unshelve.
    all: esc.
  - destruct k as [| k0].
    { replace (n + 1) with (S n) by flia.
      ...
      { ih_by IH C (SBo n 0 (5 + 4 * n))
          ltac:(applys_eq (CC_C_Bo0_odd_tail n (2 * n + 1)); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      ...
      split_sideRLs_concat.
      { ih_by IH C (SPe (n + 1) (2 * k0 + 1))
          ltac:(applys_eq (CC_C_Pe_odd n k0); flia). }
      Unshelve.
      all: esc. }
  - replace (2 * k + 1) with (S (2 * k)) by flia.
    replace (7 + 4 * n + 2 * k) with (S (6 + 4 * n + 2 * k)) by flia.
    normalize_split_sideRLs_concat.
    { ih_by IH C (SPe (n + 2) (2 * k))
        ltac:(applys_eq (CC_C_Pe_succ_even n k); flia). }
    Unshelve.
    all: esc.
  - destruct k as [| k0].
    { rewrite to_side_SPo_zero_step.
      ...
      split_sideRLs_concat.
      { ih_by IH C (SBe n 0 (5 + 4 * n))
          ltac:(applys_eq (CC_C_Be0_odd_tail n (2 * n + 1)); flia). }
      Unshelve.
      all: esc. }
    { replace (2 * S k0) with (S (2 * k0 + 1)) by flia.
      replace (3 + 4 * n + 2 * S k0) with (S (4 + 4 * n + 2 * k0)) by flia.
      ...
      split_sideRLs_concat.
      { ih_by IH C (SPo n (2 * k0 + 1))
          ltac:(applys_eq (CC_C_Po_odd n k0); flia). }
      Unshelve.
      all: esc. }
  - destruct k as [| k0].
    { change (sideRLs (flip tm) [((E, []), (F, []))]
        (to_side (SPe n 0)) (to_side (SPe n 0))).
      destruct n as [| n0].
      { rewrite to_side_SPe_zero_step. apply sideRLs_E_keep_1. }
      rewrite to_side_SPe_succ_zero_step. apply sideRLs_E_keep_1. }
    replace (4 * S k0) with (S (4 * k0 + 3)) by flia.
    rewrite (to_side_SPe_succ_step n (4 * k0 + 3)).
    apply sideRLs_E_keep_1.
  - destruct k as [| k0].
    { change (sideRLs (flip tm) [((E, []), (F, []))]
        (to_side (SPo n 0)) (to_side (SPo n 0))).
      rewrite to_side_SPo_zero_step. apply sideRLs_E_keep_1. }
    replace (4 * S k0) with (S (4 * k0 + 3)) by flia.
    rewrite (to_side_SPo_succ_step n (4 * k0 + 3)).
    apply sideRLs_E_keep_1.
  - replace (4 * k + 2) with (S (4 * k + 1)) by flia.
    rewrite (to_side_SBe_succ_step n 0 (4 * k + 1)).
    apply sideRLs_E_keep_1.
  - replace (4 * k + 2) with (S (4 * k + 1)) by flia.
    rewrite (to_side_SBo_succ_step n 0 (4 * k + 1)).
    apply sideRLs_E_keep_1.
  - rewrite to_side_SAe_zero_step.
  ...
  - replace (7 + 4 * n) with (S (4 * n + 6)) by flia.
    ...
    normalize_split_sideRLs_concat.
    {
      ...
      ih_by IH C (SAe n n (4 * q2 + 6))
        ltac:(applys_eq (CC_C_Ae_long_diag_low n (2 * q2 + 1)); flia).
    }
    Unshelve.
    all: esc.
  - replace (7 + 4 * n) with (S (4 * n + 6)) by flia.
    ...
    normalize_split_sideRLs_concat.
    {
      ...
      ih_by IH C (SAo n n (4 * q2 + 6))
        ltac:(applys_eq (CC_C_Ao_long_diag_low n (2 * q2 + 1)); flia).
    }
    Unshelve.
    all: esc.
  ...
  - destruct m as [| m0].
    { replace (4 * 0 + 3) with (S 2) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SBe n 0 (4 * q2 + 5))
          ltac:(applys_eq (CC_C_Be0_odd_tail n (2 * q2 + 1)); flia).
      }
      Unshelve.
      all: esc. }
    { replace (4 * S m0 + 3) with (S (4 * m0 + 6)) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SAe n m0 (4 * q2 + 6))
          ltac:(applys_eq (CC_C_Ae_long_nonmax n m0 (2 * q2 + 1)); flia).
      }
      Unshelve.
      all: esc. }
  - destruct m as [| m0].
    { replace (4 * 0 + 3) with (S 2) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SBo n 0 (4 * q2 + 5))
          ltac:(applys_eq (CC_C_Bo0_odd_tail n (2 * q2 + 1)); flia).
      }
      Unshelve.
      all: esc. }
    { replace (4 * S m0 + 3) with (S (4 * m0 + 6)) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SAo n m0 (4 * q2 + 6))
          ltac:(applys_eq (CC_C_Ao_long_nonmax n m0 (2 * q2 + 1)); flia).
      }
      Unshelve.
      all: esc. }
  - rewrite to_side_SBe_zero_step.
  ...
  - destruct m as [| m0].
    { replace (4 * 0 + 3) with (S 2) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SPe (n + 1) (4 * j + 3))
          ltac:(applys_eq (CC_C_Pe_odd n (2 * j + 1)); flia).
      }
      Unshelve.
      all: esc. }
    { replace (4 * S m0 + 3) with (S (4 * m0 + 6)) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SAo n m0 (10 + 4 * n + 4 * j))
          ltac:(applys_eq (CC_C_Ao_long_nonmax n m0 (3 + 2 * n + 2 * j)); flia).
      }
      Unshelve.
      all: esc. }
  - replace (4 * m + 4) with (S (4 * m + 3)) by flia.
  ...
  - destruct m as [| m0].
    { replace (4 * 0 + 3) with (S 2) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SPo n (4 * j + 3))
          ltac:(applys_eq (CC_C_Po_odd n (2 * j + 1)); flia).
      }
      Unshelve.
      all: esc. }
    { replace (4 * S m0 + 3) with (S (4 * m0 + 6)) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SAe n m0 (10 + 4 * n + 4 * j))
          ltac:(applys_eq (CC_C_Ae_long_nonmax n m0 (3 + 2 * n + 2 * j)); flia).
      }
      Unshelve.
      all: esc. }
  - replace (4 * m + 4) with (S (4 * m + 3)) by flia.
  ...
  - replace (4 * (n + 1 + 0) + 3) with (S (4 * n + 6)) by flia.
    ...
    normalize_split_sideRLs_concat.
    {
      ...
      ih_by IH C (SAo n n (10 + 4 * n + 4 * (j + 1)))
        ltac:(applys_eq (CC_C_Ao_long_diag_high n (2 * j)); flia).
    }
    Unshelve.
    all: esc.
  ...
  - replace (4 * (n + 1 + 0) + 3) with (S (4 * n + 6)) by flia.
    ...
    normalize_split_sideRLs_concat.
    {
      ...
      ih_by IH C (SAe n n (10 + 4 * n + 4 * (j + 1)))
        ltac:(applys_eq (CC_C_Ae_long_diag_high n (2 * j + 2)); flia).
    }
    Unshelve.
    all: esc.
  - replace (n + 1) with (S n) by flia.
  ...
  - destruct n as [| n0].
    ...
    split_sideRLs_concat.
    {
      ...
      ih_by IH C (SAe n0 n0 (10 + 4 * n0))
        ltac:(applys_eq (CC_C_Ae_long_diag_high n0 0); flia).
    }
    Unshelve.
    all: esc.
  - replace 2 with (S 1) by flia.
  ...
  - destruct m as [| m0].
    ...
    { replace (4 * S m0 + 5) with (S (4 * m0 + 8)) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SBo n (m0 + 1) (10 + 4 * n))
          ltac:(applys_eq (CC_C_Bo_pos_long n (m0 + 1) (2 * n + 3)); flia).
      }
      Unshelve.
      all: esc. }
  - replace (4 * m + 6) with (S (4 * m + 5)) by flia.
  ...
  - destruct m as [| m0].
    ...
    { replace (4 * S m0 + 1) with (S (4 * m0 + 4)) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SBe (n + 1) (m0 + 1) (10 + 4 * n))
          ltac:(applys_eq (CC_C_Be_pos_long (n + 1) (m0 + 1) (2 * n + 3)); flia).
      }
      Unshelve.
      all: esc. }
    ...
    { replace (4 * 0 + 3) with (S 2) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        { ih_by IH F (SBe (n + 1) (n + 1) 2)
            ltac:(apply CC_F_Be_small2). }
        ih_by IH C (SPe (n + 1) (4 * (n + 1) + 3))
          ltac:(applys_eq (CC_C_Pe_odd n (2 * n + 3)); flia).
      }
      Unshelve.
      all: esc. }
    { replace (4 * S m0 + 3) with (S (4 * m0 + 6)) by flia.
      ...
      normalize_split_sideRLs_concat.
      {
        ...
        ih_by IH C (SAo n m0 (14 + 8 * n))
          ltac:(applys_eq (CC_C_Ao_long_nonmax n m0 (4 * n + 5)); flia).
      }
      Unshelve.
      all: esc. }
  - replace (4 * m + 4) with (S (4 * m + 3)) by flia.
  ...
  - replace (4 * n + 7) with (S (4 * n + 6)) by flia.
    ...
    normalize_split_sideRLs_concat.
    {
      ...
      ih_by IH C (SAo n n (14 + 8 * n))
        ltac:(applys_eq (CC_C_Ao_long_diag_high n (2 * n)); flia).
    }
    Unshelve.
    all: esc.
Qed.
...
Lemma B_to_C h :
  Bcfg h -[ tm ]->+ to_side h {{{ ((C, []), L) }}} (S1 >> const S0).
Proof.
  unfold Bcfg, tm.
  step1s.
Qed.
...
Lemma boundary_D0_Pe4_to_B n k :
  to_side (SPe n (4 * k)) {{{ ((D, []), R) }}} const S0 -[ tm ]->+
  Bcfg (SBe n k 2).
Proof.
  unfold Bcfg.
  cbn [to_side].
...
Lemma boundary_D0_Po4_to_B n k :
  to_side (SPo n (4 * k)) {{{ ((D, []), R) }}} const S0 -[ tm ]->+
  Bcfg (SBo n k 2).
Proof.
  unfold Bcfg.
  cbn [to_side].
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Pe_succ_even n 0); lia.
    + cbn [to_side].
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Po_even n 0); lia.
    + cbn [to_side].
      replace (6 + 4 * n + 2 * 0) with (6 + 4 * n) by lia.
      replace (10 + 4 * n) with (S (S (S (S (6 + 4 * n))))) by lia.
      repeat rewrite Be_succ_step.
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Be_pos_long n j k); lia.
    + cbn [to_side].
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Be_pos_tail2 n j); lia.
    + eapply progress_trans.
      * apply marker1_A.
      * cbn [to_side].
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Be0_even_tail n k); lia.
    + cbn [to_side].
      replace (2 * k + 4) with (S (S (S (S (2 * k))))) by lia.
      repeat rewrite Be_succ_step.
      apply Btail_E_to_B.
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Be_diag_long_low n k); lia.
    + cbn [to_side].
      replace (2 * k + 4) with (S (S (S (S (2 * k))))) by lia.
      repeat rewrite Bo_succ_step.
      apply Btail_E_to_B.
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Bo_pos_long n j k); lia.
    + cbn [to_side].
      replace (2 * k + 4) with (S (S (S (S (2 * k))))) by lia.
      repeat rewrite Bo_succ_step.
      apply Btail_E_to_B.
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Bo_pos_tail2 n j); lia.
    + eapply progress_trans.
      * apply marker1_A.
      * cbn [to_side].
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Bo0_even_tail n k); lia.
    + cbn [to_side].
      replace (2 * k + 4) with (S (S (S (S (2 * k))))) by lia.
      repeat rewrite Bo_succ_step.
      apply Btail_E_to_B.
...
Proof.
  ...
  - eapply progress_trans.
    + apply ClosedCall_progress_any.
      applys_eq (CC_C_Bo_diag_long_low n k); lia.
    + cbn [to_side].
      replace (2 * k + 4) with (S (S (S (S (2 * k))))) by lia.
      repeat rewrite Be_succ_step.
      apply Btail_E_to_B.
...
Proof.
  apply without_counter with (n := 354).
