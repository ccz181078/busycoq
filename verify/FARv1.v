...
Lemma nonhalt141: ~halts (TM_from_str "1RB1RD_0RC1RE_1LD0RE_1LB---_0RA1LF_0LE0LF") c0.
Proof. solve_cert (CPS_LRU_FAR 2000000 1000000 12 3200 1 2 15 0). Time Qed.

Lemma nonhalt142: ~halts (TM_from_str "1RB1RE_1LC0RF_1RE0LD_1LC0LB_1RA0RE_1RC---") c0.
Proof. solve_cert (CPS_LRU_FAR 2000000 1000000 24 3200 4 7 11 0). Time Qed.

Lemma nonhalt143: ~halts (TM_from_str "1LB1RA_1LC0LA_1LD0LF_0RE1LB_1RC1RE_---0RE") c0.
Proof. solve_cert (RWL_mod_FAR 20000000 10000000 6 3200 2 3 6 0). Time Qed.
...
Lemma nonhalt148: ~halts (TM_from_str "1LB0LE_0LC---_1RD0RE_1LA0RD_1RC1LF_1LD1RA") c0.
Proof. solve_cert (RWL_mod_FAR 2000000 1000000 8 3200 2 24 8 0). Time Qed.

Lemma nonhalt149: ~halts (TM_from_str "1LB1RC_1LC0RB_1LD0LF_0LE---_1RB0RF_1RE1LA") c0.
Proof. solve_cert (RWL_mod_FAR 2000000 1000000 8 3200 2 24 8 0). Time Qed.

Lemma nonhalt150: ~halts (TM_from_str "1LB0RA_1LC0LE_0LD---_1RA0RD_1RD1LF_1LA1RB") c0.
Proof. solve_cert (RWL_mod_FAR 6000000 3000000 8 3200 2 24 8 0). Time Qed.

Lemma nonhalt151: ~halts (TM_from_str "1LB0RA_1LC0LE_0LD---_1RA1RF_1RD1LF_1LA1RB") c0.
Proof. solve_cert (RWL_mod_FAR 6000000 3000000 8 3200 2 24 8 0). Time Qed.

Lemma nonhalt152: ~halts (TM_from_str "1LB0RA_1LC0RA_1LD---_1RE1LF_1RF1RE_1RA0LF") c0.
Proof. solve_cert (RWL_mod_FAR 60000000 30000000 21 3200 4 1 6 0). Time Qed.

Lemma nonhalt153: ~halts (TM_from_str "1LB---_1RC1LD_1RD1RC_1RE0LD_1LF0RE_1LA0RE") c0.
Proof. solve_cert (RWL_mod_FAR 60000000 30000000 21 3200 4 1 6 0). Time Qed.

Lemma nonhalt154: ~halts (TM_from_str "1RB0RF_0RC---_0LD1RA_1RE1LF_1RC0RE_1LD0LF") c0.
Proof. solve_cert (CPS_LRU_FAR 40000000 20000000 1 3200 29 0 0 0). Time Qed.

Lemma nonhalt155: ~halts (TM_from_str "1RB---_1RC1LE_1RD0RC_0LB1RF_1LB0LE_1RA0RE") c0.
Proof. solve_cert (CPS_LRU_FAR 12000000 6000000 2 3200 10 4 12 0). Time Qed.

Lemma nonhalt156: ~halts (TM_from_str "1LB1RD_0LC1LE_1RD0LA_0RE0LF_1LA0RC_---1LD") c0.
Proof. solve_cert (RWL_mod_FAR 2000000 1000000 12 3200 100 1 8 0). Time Qed.

Lemma nonhalt157: ~halts (TM_from_str "1LB0RD_1LC1RE_0LD1LA_1RE0LB_0RA0LF_---1LE") c0.
Proof. solve_cert (RWL_mod_FAR 2000000 1000000 12 3200 100 1 8 0). Time Qed.

Lemma nonhalt158: ~halts (TM_from_str "1RB0LD_0RC0LF_1LD0RA_1LE1RB_0LA1LC_---1LB") c0.
Proof. solve_cert (RWL_mod_FAR 2000000 1000000 12 3200 100 1 8 0). Time Qed.

Lemma nonhalt159: ~halts (TM_from_str "1LB0RD_1LC1LF_0LD1LA_1RE0LB_0RA0LA_1RE---") c0.
Proof. solve_cert (RWL_mod_FAR 2000000 1000000 12 3200 100 1 8 0). Time Qed.

Lemma nonhalt160: ~halts (TM_from_str "1LB1LF_0LC1LE_1RD0LA_0RE0LE_1LA0RC_1RD---") c0.
Proof. solve_cert (RWL_mod_FAR 2000000 1000000 12 3200 100 1 8 0). Time Qed.

Lemma nonhalt161: ~halts (TM_from_str "1RB0LD_0RC0LC_1LD0RA_1LE0LF_0LA1LC_0RA---") c0.
Proof. solve_cert (RWL_mod_FAR 2000000 1000000 12 3200 100 1 8 0). Time Qed.
