(** * Instantiating the development to machines with 2 states and 5 symbols *)
...
Module BB25 <: Ctx.
  ...
  match a,b with
  | S0,S0 | S1,S1 | S2,S2 | S3,S3 | S4,S4 => true
  | _,_ => false
  end.
  ...
  Definition all_syms := [S0; S1; S2; S3; S4].
