...
Require Import BigInt.NTTConcrete BigInt.NTTKernelBounded BigInt.BigIntMul
  BigInt.NTTConcrete469Squares BigInt.NTTConcrete469Inverse BigInt.NTTConcrete469InvPow2.

Module Prime469KBSupported := TreeNTTKernelBounded(Prime469Cfg).
Module Prime469SupportedFacts.
  Module T := Prime469KBSupported.T.
  Module K := Prime469KBSupported.K.
  Module Spect := Prime469KBSupported.Spect.
  Module Sq := Prime469SquareFacts.
  Module Inv := Prime469InverseFacts.
  Module Pow := Prime469InvPow2Facts.
  Import T Spect.
  ...
  Proof.
    ...
    - set (r := value (root (S n))).
      ...
      assert (Hir : zcanon ir = ir).
      {
        subst ir.
        apply zcanon_small.
        apply Prime469Cfg.inv_root_range.
      }
      assert (Hr : zcanon r = r).
      {
        subst r.
        apply zcanon_small.
        apply Prime469Cfg.root_range.
      }
